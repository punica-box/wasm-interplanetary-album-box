...
from flask import Flask, request, json, send_from_directory, render_template, redirect
...
def get_item_list_from_contract(identity_acct: Account) -> list:
    ...
    tx = sdk.wasm_vm.make_invoke_transaction(app.config['CONTRACT_ADDRESS_HEX'], get_item_list_func,
